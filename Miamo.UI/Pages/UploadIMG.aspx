<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="UploadIMG.aspx.cs" Inherits="Miamo.UI.Pages.UploadIMG" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-3 col-md-offset-2">
                    <asp:Button ID="btnUpload" runat="server" Text="Upload Images" CssClass="btn btn-primary btn-group-lg" OnClick="btnUpload_Click"/>
