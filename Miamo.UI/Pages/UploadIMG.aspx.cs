        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                if (img01.HasFile)
                {
                    ...
                    string SavePath = Server.MapPath("~/Img/index/");
                    ...
                    SqlCommand cmd1 = new SqlCommand("INSERT INTO ImgCarrousel VALUES ('" + fileName + "','" + extension + "')", con);
                ...
                if (img02.HasFile)
                {
                    ...
                    SqlCommand cmd2 = new SqlCommand("INSERT INTO ImgCarrousel VALUES ('" + fileName + "','" + extension + "')", con);
                ...
                if (img03.HasFile)
                {
                    ...
                    SqlCommand cmd3 = new SqlCommand("INSERT INTO ImgCarrousel VALUES ('" + fileName + "','" + extension + "')", con);
                ...
                if (img04.HasFile)
                {
                    ...
                    SqlCommand cmd4 = new SqlCommand("INSERT INTO ImgCarrousel VALUES ('" + fileName + "','" + extension + "')", con);
                ...
                if (img05.HasFile)
                {
                    ...
                    SqlCommand cmd5 = new SqlCommand("INSERT INTO ImgCarrousel VALUES ('" + fileName + "','" + extension + "')", con);
