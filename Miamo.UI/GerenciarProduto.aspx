<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="GerenciarProduto.aspx.cs" Inherits="Miamo.UI.GerenciarProduto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView runat="server" ID="gv2" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="IdAlbum"
        ...
        <Columns>
            <asp:TemplateField HeaderText="Album">
                <ItemTemplate>
                    <asp:Label runat="server" Text='<%#Eval("NomeAlbum") %>' />
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="txtNomeAlbum" runat="server" MaxLength="50" Text='<%#Eval("NomeAlbum") %>' />
                </EditItemTemplate>
                <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Artista">
                <ItemTemplate>
                    <asp:Label runat="server" Text='<%#Eval("ArtistaAlbum") %>' />
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="txtArtistaAlbum" runat="server" MaxLength="50" Text='<%#Eval("ArtistaAlbum") %>' />
                </EditItemTemplate>
                <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Selo">
                <ItemTemplate>
                    <asp:Label runat="server" Text='<%#Eval("SeloAlbum") %>' />
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="txtSeloAlbum" runat="server" MaxLength="50" Text='<%#Eval("SeloAlbum") %>' />
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtSeloAlbumFooter" runat="server" />
                </FooterTemplate>
            </asp:TemplateField>
